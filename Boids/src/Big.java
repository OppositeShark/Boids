...
public class Big extends Boid{
	...
	final static double constAcceleration = 400;
	final static double resistance = -5.0;
	
	final static double senseRange = 300;
	final static double senseAng = Math.PI*(3.0/6.0);
	final static double avoidDist = 70;
	final static int maxSee = 30;
	...
	public void draw(Graphics2D g2d) {
		...
		*/
		...
		copy.setPaint(new Color(255, 0, 255));
